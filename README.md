...
프로젝트는 크게 두 가지 주요 서비스를 제공합니다.
  1. 웹과 앱 환경에서 학생들의 질문에 대한 답을 제공하는 챗봇
  2. 웹에서 간단한 코딩 실습이 가능한 온라인 저지 시스템을 제공   
  
대학 내의 파이썬 수업과 직접 연계되어 학생들로부터 수많은 질문을 받고 답변을 만들어 5000개 이상의 Q&A 데이터로 학습을 진행했습니다.  
실제 수업에 적용하여 학생들이 사용하였고 피드백을 받아 수렴하고 보완하는 과정을 거쳤습니다.
<br/><br/>
...
### 팀원들과의 의견 충돌
아이디어 선정 과정부터 프로젝트를 마무리하는 과정까지 팀원들과의 의견이 대립되는 경우가 여럿 발생하였고 서로의 주장에 근거를 뒷받침하여 설득하거나 합의점을 찾는 등 의사소통의 방법들을 배웠습니다. 또한 모든 의사결정은 좀 더 나은 서비스를 위한 것이 될 수 있도록 노력하였습니다.
<br/><br/><br/>
